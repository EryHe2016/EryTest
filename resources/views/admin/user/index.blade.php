        ...
        <div id="DataTables_Table_1_wrapper" class="dataTables_wrapper" role="grid">
            ...
            <table class="mws-datatable-fn mws-table dataTable" id="DataTables_Table_1"
                ...
                <tr class="odd even ">
                    ...
                    <td class=" ">
                        <img src="{{$user->profile}}" width="50" alt="">
                    </td>

                    <td class=" ">
                        <a href="/user/edit/{{$user->id}}" class="btn"><i class="icon-pencil"></i></a>
                        <a href="/user/delete/{{$user->id}}" class="btn btn-warning"><i class="icon-remove-sign"></i></a>
                    </td>
                </tr>
                @endforeach
                </tbody>
